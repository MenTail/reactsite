...
const ServizComponent = (props) => {

     const itemsList = [
        { id: 91, name: "#S287537", imgurl: "/imgs/tovar/servizi/01.png", price: 600 },
        { id: 92, name: "#S284457", imgurl: "/imgs/tovar/servizi/02.png", price: 900 },
    ];
    ...
    return (
        ...
        <section className="app">        
            ...
            <MenuComponent imgico={"/imgs/tovar/buy.png"} cllas="buy mx-2" bas="Корзина :" basket={totalItems.length} ht="шт. |" pri={totalItems.reduce((accumulator, item)=>{return accumulator += item.price;}, 0 )} ua={"грн"} />
                ...
                <div className="bg-dark mt-1 pt-3 p-2 text-white"><h3>Сервізи</h3></div>
...
export default ServizComponent;
